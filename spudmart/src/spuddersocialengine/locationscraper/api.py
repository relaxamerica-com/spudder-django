...
import spuddersocialengine.locationscraper.spudmart.api
import spuddersocialengine.locationscraper.socialnetworks
from spuddersocialengine.locationscraper.models import *
    ...
    if request.method == 'GET':
        if 'key' in request.GET and request.GET['key'] != '':
            ...
            if validate_api_key(api_key):
                ...
                venues_json = spuddersocialengine.locationscraper.spudmart.api.call_venues_api(request)
                ...
                spuddersocialengine.locationscraper.spudmart.api.send_posts_for_venue(json_response)
            else:
    ...
    if request.method == 'GET':
        if ('key' in request.GET and request.GET['key'] != '') and \
            ...
            if validate_api_key(api_key):
                ...
                spuddersocialengine.locationscraper.spudmart.api.send_posts_for_venue(venues_return)
