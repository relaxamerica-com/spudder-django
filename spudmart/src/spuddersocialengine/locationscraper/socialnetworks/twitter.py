...
from spuddersocialengine.locationscraper import spice_settings
from spuddersocialengine.locationscraper.socialnetworks import twitter_settings

from spuddersocialengine.locationscraper.models import TwitterPolling, TwitterDataProcessor
