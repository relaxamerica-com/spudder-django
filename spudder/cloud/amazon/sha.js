/**
 * SHA generator based on jsSHA library.
 *  Reference: https://github.com/Caligatio/jsSHA
 */

module.exports = function (srcString, inputFormat) {
    ...
    return new jsSHA(srcString, inputFormat);
};