...
urlpatterns = patterns('spudmart.venues.views',
    ...
    (r'^save_temp_name/(?P<venue_id>\d+)$', 'save_temp_name'),
    (r'^edit_temp_cover/(?P<venue_id>\d+)','edit_temp_cover'),
    (r'^save_temp_cover/(?P<venue_id>\d+)', 'save_temp_cover'),
    (r'^reset_temp_cover/(?P<venue_id>\d+)', 'reset_temp_cover'),
    (r'^temp_to_real_venue/(?P<venue_id>\d+)$', 'temp_to_real_venue'),
    ...
    (r'^save_cover/(?P<venue_id>\d+)$', 'save_cover'),
    (r'^reset_cover/(?P<venue_id>\d+)$', 'reset_cover'),
    (r'^edit_cover/(?P<venue_id>\d+)$', 'edit_cover'),
    ...
    (r'^accept_spud/(?P<venue_id>\d+)/(?P<spud_from_social_media_id>\d+)$', 'accept_spud_from_social_media'),
    (r'^reject_spud/(?P<venue_id>\d+)/(?P<spud_from_social_media_id>\d+)$', 'reject_spud_from_social_media'),
